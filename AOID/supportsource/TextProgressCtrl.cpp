...
public:
	...
	XCMemDC(CDC* pDC) : CDC()
	{
		...
		m_pDC = pDC;
		m_pOldBitmap = NULL;
		m_bXMemDC = !pDC->IsPrinting();

		if (m_bXMemDC)    // Create a Memory DC
		{
	...
	XCMemDC* operator->() {return this;}
	// Allow usage as a pointer
	operator XCMemDC*() {return this;}
...
private:
	...
	BOOL     m_bXMemDC;      // TRUE if CDC really is a Memory DC.
};
